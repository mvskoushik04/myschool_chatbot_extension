...
export const getHardcodedResponse = (intent: string): { steps: string[], url: string } => {
    const responses = {
      ...
      raiserequest: {
        steps: [
          '• Click on the issue icon in this chatbot',
          '• Type your message',
          '• Send the issue'
        ],
        url: ''
